...
async def create_knowledge(
    ...
    entry = KnowledgeEntry(
        ...
        ingest_status="processing" if is_auto_approved else "pending",
    ...
    if is_auto_approved:
        ...
        background_tasks.add_task(process_knowledge_background, entry.id, target_ws.id)
        ...
        if normalized_visibility == VISIBILITY_PUBLIC:
            ...
            for other_ws in other_workspaces:
                if other_ws.id != target_ws.id:
                    background_tasks.add_task(process_knowledge_background, entry.id, other_ws.id)
