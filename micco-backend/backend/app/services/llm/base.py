...
class STTProvider(ABC):
    ...
    def transcribe_sync(
        ...
        *,
        ...
        """
        Synchronous transcription of a mono PCM waveform.

        Args:
            audio: 1-D numpy array of float32 samples in [-1, 1], mono.
            sample_rate: Sample rate of `audio` in Hz.
            language: Optional language hint (e.g. "vi"); providers may ignore.
    ...
    async def transcribe(
        ...
        *,
        ...
        """
        Async transcription.
        Default: runs transcribe_sync() in a thread pool.
        """
        return await asyncio.to_thread(
            self.transcribe_sync, audio, sample_rate=sample_rate, language=language
        )
